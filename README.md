...
* Fields in the palette are may be shown to the user depending on their support in the rest of your system
* Almost every new feature added can be turned off with an easy switch.
